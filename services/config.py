...
class ConfigStore:
    ...
    @property
    def account_route_strategy(self) -> str:
        value = str(self.data.get("account_route_strategy", "round_robin")).strip()
        if value in ("round_robin", "plus_first", "plus_only", "free_only"):
            return value
        return "round_robin"
    ...
    def get(self) -> dict[str, object]:
        ...
        data["account_route_strategy"] = self.account_route_strategy
